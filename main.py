...
def check_arg(args):
    ...
    results.dataset_root = '/kaggle/working/ppe'  # Thay đường dẫn tới bộ dữ liệu của bạn
    results.depth_root = '/kaggle/working/ppe/depth'  # Đường dẫn tới depth map nếu có
